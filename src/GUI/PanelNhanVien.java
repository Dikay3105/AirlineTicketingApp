        ...
        fc.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    new ImportExcel().ImportExcel_NhanVien(filePath);
                    reset();
                }
            }
        });
        ...
        btnXuatFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(null, NhanVienBUS.xuatExcel(filePath+".xlsx"), "Thông báo", 1);
                try {
                    Desktop.getDesktop().open(new File(NhanVienBUS.pathExcel));
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
                    ...
                    for (int i = 0; i < 8; i++) {
                        ...
                        } else if (headerValue.equals("Chức Vụ")) {
...
//Tìm Kiếm 
    ...
    public void loadtable() {
        ...
        model.setColumnIdentifiers(new Object[]{
            "STT", "Mã Nhân Viên", "Mật Khẩu", "Họ Tên", "Giới Tính", "Ngày Sinh", "Chức Vụ", "Email"/*, "Hệ Số"*/
        });
         String tmpString="";
        for (NhanVienDTO s : NVLIST) {
            if (s.getXuLy() == 1) {
                if(s.getGioiTinh()==0) tmpString="Nữ";
                else tmpString="Nam";
                model.addRow(new Object[]{
                    i++, s.getMaNV(), s.getmKNV(), s.getTenNV(), tmpString, s.getNgaySinhString(), s.getChucVu(), s.getEmail()/*, s.getHeSoLuong()*/
                });
...
//                column.setCellRenderer(renderer);
    ...
    public void loadtable(ArrayList<NhanVienDTO> listNhanVien) {
        ArrayList<NhanVienDTO> NVLIST = new ArrayList<>();
        int i = 1;
        model = (DefaultTableModel) jTable.getModel();
        model.setColumnIdentifiers(new Object[]{
...
//////////////////////////////////////////////////  
                if (!gtinh.isEmpty() && !gtinh.equals("Giới Tính")) {
                    for (NhanVienDTO x : listNhanVien) {
                        if (x.getGioiTinh()==1 && gtinh.equals("Nam")) {
                            listTemp.add(x);
                        }
                        else if(x.getGioiTinh()==0 && gtinh.equals("Nữ")) {
                            listTemp.add(x);
                        }
                    }
                    listNhanVien.clear();
                ...
                if (!pban.isEmpty() && !pban.equals("Chức Vụ")) {
                    for (NhanVienDTO x : listNhanVien) {
                        if (x.getChucVu().equals(pban)) {
                            listTemp.add(x);
                        }
                    }
                    listNhanVien.clear();
