...
public class AdminGUI {
    ...
    private JLabel lbSoDo = new JLabel("Chuyến bay");
    ...
    private JButton btnLogOut = new JButton("Đăng xuất");
        private PanelVeBay a=new PanelVeBay();
...
//Vĩnh Khoa
    ...
    JLabel lbLogo = new JLabel("Deadline Airlines");
    ...
    public void initComponents() throws IOException {
        ...
        frBackground.setTitle("QUẢN LÝ BÁN VÉ MÁY BAY");
        ...
        //@@@@@@@@@@@@ Menu button
        JButton btn1 = new JButton("Chuyến bay");
        btn1.setToolTipText("Quản lý chuyến bay");
        ...
        JButton btn4 = new JButton("Đường bay");
        btn4.setToolTipText("Quản lý đường bay");
        JButton btn5 = new JButton("Dịch vụ");
        btn5.setToolTipText("Quản lý dịch vụ");
        JButton btn6 = new JButton("Máy bay");
        btn6.setToolTipText("Quản lý máy bay");
        ...
        JButton btn9 = new JButton("Vé bay");
        btn9.setToolTipText("Quản lý vé bay");
        JButton btn11 = new JButton("Cài đặt");
        btn9.setToolTipText("Cài đặt");
        //icon 
        ImageIcon icon1 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/plane.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn1.setIcon(icon1);
//        btn1.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(getClass().getResource("/GUI/asset/khachhang48.png"))));
        ...
        btn3.setIcon(icon3);
        ImageIcon icon4 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/duongbay.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn4.setIcon(icon4);
        ...
        btn5.setIcon(icon5);
        ImageIcon icon6 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/sodo.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn6.setIcon(icon6);
        ...
        btn8.setIcon(icon8);
        ImageIcon icon9 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/tic.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        btn9.setIcon(icon9);
        ImageIcon icon11 = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/caidat.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH));
        ...
        ImageIcon iconLogo = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/vnal.png")).getImage().getScaledInstance(60, 50, Image.SCALE_SMOOTH));
        ...
        btnDarkLight.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (LightDark == 0) {
                    ...
                    LightDark = 1;
                    if (menu == 1) {
                        pnChuyenBay.lightDark(LightDark);
                    }
                    if (menu == 2) {
                    ...
                    if (menu == 6) {
                        //pnMayBay.lightDark(LightDark);
                    }
                    if (menu == 8) {
                        pnHoaDon.lightDark(LightDark);
                    }
                    if (menu == 9) {
                        tmpJPanel.lightDark(LightDark);
                    }
                } else {
                    btnDarkLight.setText("Dark mode");
                    lblInforJLabel.setForeground(Color.black);
...
//                        pnHoaDon.lightDark(LightDark);
    ...
    public void contentDuongBay() {
        pnContent.removeAll();
        pnContent.revalidate();
        pnContent.repaint();
        JPanel tmpJPanel=new DuongBayGUI();
       // pnPhong = new DuongBayGUI();
        pnContent.setLayout(new BorderLayout());
        pnContent.add(tmpJPanel, BorderLayout.CENTER);
    }
    ...
    public void contentMayBay() {
        pnContent.removeAll();
        pnContent.revalidate();
        pnContent.repaint();
        pnMayBay = new MayBayPanel();
        pnContent.setLayout(new BorderLayout());
        pnContent.add(pnMayBay, BorderLayout.CENTER);
    }

    PanelChuyenBay2 pnChuyenBay;

    public void contentChuyenBay() {
        pnContent.removeAll();
        pnContent.revalidate();
        pnContent.repaint();
        pnChuyenBay = new PanelChuyenBay2();
        pnContent.setLayout(new BorderLayout());
        pnChuyenBay.lightDark(LightDark);
        pnContent.add(pnChuyenBay, BorderLayout.CENTER);
    ...
    public void contentThongKe() throws SQLException, ParseException {
        pnContent.removeAll();
        pnContent.revalidate();
        pnContent.repaint();
