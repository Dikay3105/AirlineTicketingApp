...
public class FormLoading extends JFrame {
    ...
    public void initComponents() {
        ...
        ImageIcon imageIcon = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/background.jpg")).getImage().getScaledInstance(1014, 637, Image.SCALE_SMOOTH));
    ...
    public void run() {
        ...
        while (counter <= 100) {
            ...
            counter += 5;
            if (pb.getValue() == 25) {
                ImageIcon imageIcon = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/bbb.jpg")).getImage().getScaledInstance(1014, 637, Image.SCALE_SMOOTH));
                lb.setIcon(imageIcon);
                lbtop.setForeground(Color.red);
                lb1.setForeground(Color.red);
            }
            if (pb.getValue() == 50) {
                ImageIcon imageIcon = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/abc.png")).getImage().getScaledInstance(1014, 637, Image.SCALE_SMOOTH));
                lb.setIcon(imageIcon);
                lbtop.setForeground(Color.red);
                lb1.setForeground(Color.red);
            }
            if (pb.getValue() == 75) {
                ImageIcon imageIcon = new ImageIcon(new ImageIcon(getClass().getResource("/GUI/asset/aaa.jpg")).getImage().getScaledInstance(1014, 637, Image.SCALE_SMOOTH));
                lb.setIcon(imageIcon);
