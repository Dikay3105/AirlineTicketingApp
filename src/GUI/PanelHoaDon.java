...
public class PanelHoaDon extends JPanel {
    ...
    ArrayList<HoaDonDTO> listHD2 = new ArrayList<>();
    ...
    public void initComponents() {
        listHD = HoaDonBUS.getListHD3();
        listHD2= HoaDonBUS.getListHD2();
        setBackground(Color.white);
        setLayout(new BorderLayout());
        txtNgayThanhToan1.setDateFormatString("dd-MM-yyyy");
        txtNgayThanhToan2.setDateFormatString("dd-MM-yyyy");
...
//        pnInput.add(pnNgayThanhToan2);
        ...
        txtTienPhong.addItem("Tiền vé");
        txtTienPhong.addItem("0 - 999999");
        txtTienPhong.addItem("1000000 - 2999999");
        txtTienPhong.addItem("3000000 - 4999999");
        txtTienPhong.addItem("5000000 - 9999999");
        txtTienPhong.addItem("Trên 10000000");
        ...
        tbHoaDon.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
                    ...
                    String tienPhong = tbHoaDon.getValueAt(tbHoaDon.getSelectedRow(), tbHoaDon.getColumnModel().getColumnIndex("Tiền vé")).toString();
                    ...
                    new ChiTietHoaDon(maHD,maNgayThanhToan,tenNV,tienPhong,tienDV,giamGia,total);
                }
            }
        });
        ...
        btnXuatFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(null, HoaDonBUS.xuatExcel(filePath+".xlsx"), "Thông báo", 1);
                try {
                    Desktop.getDesktop().open(new File(HoaDonBUS.pathExcel));
        ...
        btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (txtMaCTT.getText().equals("Mã vé")
                    ...
                    if (txtNgayThanhToan1.getDate()!=null && txtNgayThanhToan2.getDate()!=null) {
                        if(txtNgayThanhToan2.getDate().after(txtNgayThanhToan1.getDate())) {
                            SimpleDateFormat sdf1 = new SimpleDateFormat("dd-MM-yyyy");
                            String day1=sdf1.format(txtNgayThanhToan1.getDate());
                            String day2=sdf1.format(txtNgayThanhToan2.getDate());;
                            for (HoaDonDTO x : listHD1) {
                                if (isDateInRange(day1, day2, x.getNgayThanhToan())) {
                                    listTemp.add(x);
                                }
                            }
                            listHD1.clear();
                            ...
                            JOptionPane.showMessageDialog(null, "Khoảng ngày lọc không hợp lệ", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                        }
                    } 
                    ...
                    if (txtTienPhong.getSelectedIndex() != 0) {
                        if (txtTienPhong.getSelectedIndex() == 5) {
                            ...
                            for (HoaDonDTO x : listHD1) {
                                int tmp=0;
                                for(HoaDonDTO hddto: listHD2) {
                                    if(hddto.getMaHD().equals(x.getMaHD())) {
                                        tmp=hddto.getTienVe();
                                        break;
                                    }
                                }
...
//    }
    ...
    public void loadTable(JTable tbHoaDon, ArrayList<HoaDonDTO> listHD) {
        ...
        int i = 1;
        String check="";
        for (HoaDonDTO hd : listHD2) {
            for(HoaDonDTO hd2:listHD) {
                if(hd.getMaHD().equals(check)) {
                    check="";
                    break;
                }
                
                if(hd.getMaHD().equals(hd2.getMaHD())) {
                    Object row[] = {i, hd2.getMaHD(), hd2.getNgayThanhToan(), NhanVienBUS.getTenNV(hd2.getMaNV()), hd.getTienVe(), hd.getTienDichVu(), hd.getGiamGia(), hd.getTongTien()};
                    dtm.addRow(row);
                    i++;
                    check=hd.getMaHD();
                }
        ...
        DefaultTableCellRenderer renderBorder = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                if (column == tbHoaDon.getColumnModel().getColumnIndex("Tiền vé")) {
    ...
    public static boolean isDateInRange(String day1, String day2, String day3) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        try {
            Date date1 = dateFormat.parse(day1);
            Date date2 = dateFormat.parse(day2);
            Date date3 = dateFormat.parse(day3);

            // Kiểm tra xem day3 có nằm trong khoảng từ day1 đến day2 hay không
            return date3.after(date1) && date3.before(date2);
        } catch (ParseException e) {
            e.printStackTrace();
            return false; // Trong trường hợp có lỗi khi chuyển đổi ngày
        }
    }
