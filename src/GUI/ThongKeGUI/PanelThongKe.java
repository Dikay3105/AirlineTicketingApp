...
//        fr.setLayout(new BorderLayout());
        ...
        lbTongThu2.setText(formatMoney(HoaDonBUS.tongTien()) + "");
        ...
        lbTongPhong1.setText("Tổng doanh thu vé");
        lbTongPhong1.setFont(sgUI18b);      
        lbTongPhong2.setText(formatMoney(HoaDonBUS.tienPhong()) + "");
        ...
        lbTongDV2.setText(formatMoney(HoaDonBUS.tienDichVu()) + "");
